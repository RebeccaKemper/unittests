sap.ui.define([
	...
	"rebecca/kemper/unittests/unittests/test/integration/pages/Common",
	"rebecca/kemper/unittests/unittests/test/integration/pages/shareOptions"
		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("A_ID"),
								name: oBindingContext.getProperty("A_NAME")
							};
						}
					}));
				},
			...
			assertions: jQuery.extend({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all Activity to be able to check for the total amount
