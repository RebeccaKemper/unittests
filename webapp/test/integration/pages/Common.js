sap.ui.define([
	...
	return Opa5.extend("rebecca.kemper.unittests.unittests.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["rebecca/kemper/unittests/unittests/localService/mockserver"], function (mockserver) {
